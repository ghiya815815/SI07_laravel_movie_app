        ...
        <div class="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="p-6 overflow-hidden">
                    ...
                    <p class="font-medium">
                        Noragami is an anime series that follows a poor deity named Yato, who desires to become a famous
                        god.
                    </p>
                </div>
            </div>
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="p-6 overflow-hidden">
                    ...
                    <p class="font-medium">
                        Haruka Sakura wants nothing to do with weaklings—he's only interested in the strongest of the
                        strong.
                    </p>
                </div>
            </div>
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="p-6 overflow-hidden">
                    ...
                    <p class="font-medium">
                        Corrupt politicians, frenzied nationalists and other seditious forces continue to jeopardize the
